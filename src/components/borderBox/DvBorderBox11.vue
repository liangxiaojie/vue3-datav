...
const titleWidth: number = props.titleWidth || 250
</script>

<template>
  <div class="dv-border-box-11" ref="boxRef">
    <svg class="dv-border-svg-container" :width="width" :height="height">
      ...
      <polygon
        :stroke="mergedColor[0]"
        :fill="fade(mergedColor[1] || defaultColor[1], 30) || undefined"
        :filter="`url(#${filterId})`"
        :points="`
      ...
      <text class="dv-border-box-11-title" :x="`${width / 2}`" y="32" fill="#fff" font-size="18" text-anchor="middle" dominant-baseline="middle">
        {{ props.title }}
      </text>
